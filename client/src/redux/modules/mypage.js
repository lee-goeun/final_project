...
const GET_LIKE_MARKET_LIST = 'mypage/GET_MARKET_LIST';
const GET_LIKE_MARKET_LIST_SUCCESS = 'mypage/GET_LIKE_MARKET_LIST_SUCCESS';

//action creator
export const getMyMarketList = createRequestThunk(GET_MARKET_LIST, api.getMyMarketList);
export const getMyMatchingList = createRequestThunk(GET_MATCHING_LIST, api.getMyMatchingList);

export const getMyLikeMarketList = createRequestThunk(GET_LIKE_MARKET_LIST, api.getMyLikeMarketList);
