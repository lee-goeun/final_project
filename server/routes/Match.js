...
router.get('/list', (req, res) => {
    ...
    if(keyword == undefined){
        ...
        keyword = "%"+keyword+"%";
        sql = "select * from matchTbl where matchDeleted = 0 and (matchTitle like ? or matchContent like ?)";
...
router.get('/listLimit1', (req, res) => {
    var sql = "select * from matchTbl where matchDeleted = 0 and matchTime between now() and  DATE_ADD(now(), INTERVAL +1 HOUR) order by matchTime;";
